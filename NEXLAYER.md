# Nexlayer — slim-jade-workadventure

**Live:** [https://kitbear-studio-slim-jade-workadventure.cloud.nexlayer.ai](https://kitbear-studio-slim-jade-workadventure.cloud.nexlayer.ai)  
...
**slim-jade-workadventure** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
> `${podName:port}` syntax. CI/CD runs on push to `nexlayer`."*
